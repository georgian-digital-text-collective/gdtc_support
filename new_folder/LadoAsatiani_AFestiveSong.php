<?php
	...
	$title = "A Festive Song ,  სალაღობო";
	top($title); ?>
				<h1><?= $title ?></h1>
				<h1 class="get">A Festive Song ,  სალაღობო</h1>
			</article>
		</article>
		<article>
		...
		<article>
            ...
            <div class = "row">
				<div class="col-lg-4 georgian col-lg-offset-2">
					<p>
					დაუკარით! და იმღერეთ შადიანი* ძველებური მხიარული სიმღერა,
				...
				<div class="col-lg-4 english">
					...
					an old-fashioned merry table song
					
					
					That Machabeli used to sing in savage battle.
					
					Play, strike up a dardiani* 
					a traditional sorrowful song
					,
            ...
            <div class = "row">
				...
				<div class="col-lg-4 english">
					...
					Play, and strike up a mosalkheni* 
					a traditional, joyous song
					:
					
					"The black chokha* 
					traditional Georgian men's jacket
					suits swarthy skin like ours!"
					</p>
				</div>
			</div>
            <div class = "row">
				...
				<div class="col-lg-4 english">
					...
					a traditional bold drinking song
					,
            ...
            <div class = "row">
				<div class="col-lg-4 georgian col-lg-offset-2">
					...
					ხომ ლამაზია ეს საქართველო, მაგრამ მე უფრო ლამაზია მინდა,
