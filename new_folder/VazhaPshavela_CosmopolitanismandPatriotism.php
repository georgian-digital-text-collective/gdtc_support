<?php
	...
	$title = "Cosmopolitanism and Patriotism ,  კოსმოპოლიტიზმი და პატრიოტიზმი";
	top($title); ?>
				<h1><?= $title ?></h1>
				<h1 class="get">Cosmopolitanism and Patriotism ,  კოსმოპოლიტიზმი და პატრიოტიზმი</h1>
			</article>
		</article>
		<article>
		...
		<article>
			...
			<div class = "row">
				<div class="col-lg-4 georgian col-lg-offset-2">
					<h1> კოსმოპოლიტიზმი და პატრიოტიზმი</h1>
				</div>
				<div class="col-lg-4 english">
					<h1>Cosmopolitanism and Patriotism</h1>
				</div>
			</div>
            <div class = "row">
				<div class="col-lg-4 georgian col-lg-offset-2">
