<?php
	...
	$title = "Memento Mori ,  Memento Mori";
	top($title); ?>
				<h1><?= $title ?></h1>
				<h1 class="get">Memento Mori ,  Memento Mori</h1>
			</article>
		</article>
		<article>
		...
		<article>
            ...
            <div class = "row">
				<div class="col-lg-4 georgian col-lg-offset-2">
					...
					ჩემს გარშემო ციხეა _ მწუხარების სავანე.
					
					რომ მდომოდა სიცოცხლე, სიკვდილს არ ვიწამებდი,
					
					მიშა არ იქნებოდა ჩემთვის შავი სამარე.
					</p>
				</div>
				<div class="col-lg-4 english">
					<p>
            ...
            <div class = "row">
				<div class="col-lg-4 georgian col-lg-offset-2">
					<p>
					სადღაც მთასთან იწვიმა, სადღაც მთასთან ბურია,
